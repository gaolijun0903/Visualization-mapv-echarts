...
//new BMap.Point(114.321317, 30.598428), 12
//new BMap.Point(106.563777, 29.578285), 12
map.centerAndZoom(new BMap.Point(114.321317, 30.598428), 12);  // 初始化地图,设置中心点坐标和地图级别
//map.centerAndZoom(new BMap.Point(citylng, citylnglat), 12);  // 初始化地图,设置中心点坐标和地图级别
map.enableScrollWheelZoom(true); // 开启鼠标滚轮缩放

// 地图自定义样式  //统一使用这个样式，不用修改
map.setMapStyle({
    styleJson: [{
        "featureType": "water",
        "elementType": "all",
